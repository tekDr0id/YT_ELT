...
def get_video_ids(playlistId):
    ...
    base_url = f"https://youtube.googleapis.com/youtube/v3/playlistItems?part=contentDetails&maxResults=1{maxResults}&playlistId={playlistId}&key={YOUTUBE_API_KEY}"
...
def extract_video_data(video_ids):
    ...
    try: 
        for batch in batch_list(video_ids, maxResults):
            ...
            url = f"https://youtube.googleapis.com/youtube/v3/videos?part=contentDetails&part=snippet&part=statistics&id={video_ids_str}&key={YOUTUBE_API_KEY}"
